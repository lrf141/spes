...
/** @file ha_spes.h
  ...
  /storage/spes/ha_spes.cc.

    @note
  Please read ha_spes.cc before reading this file.
  Reminder: The spes storage engine implements all methods that are
  *required* to be implemented. For a full list of all methods that you can
  implement, see handler.h.

   @see
  /sql/handler.h and /storage/spes/ha_spes.cc
*/
...
class ha_spes : public handler {
  ...
  */
  ...
  /*
    Everything below are methods that we implement in ha_spes.cc.

    Most of these methods are not obligatory, skip them and
    MySQL will treat them as not implemented
  */
  /** @brief
    We implement this in ha_spes.cc; it's a required method.
  */
  ...
  */
  ...
  /** @brief
    We implement this in ha_spes.cc. It's not an obligatory method;
