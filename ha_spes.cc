...
/**
  ...
  @brief
  The ha_spes engine is a stubbed storage engine for spes purposes only;
  it does nothing at this point. Its purpose is to provide a source
  code illustration of how to begin writing new storage engines; see also
  /storage/spes/ha_spes.h.

  @details
  ha_spes will let you create/open/delete tables, but
  nothing further (for spes, indexes are not supported nor can data
  be stored in the table). Use this spes as a template for
  implementing the same functionality in your own storage engine. You
  can enable the spes storage engine in your build by doing the
  ...
  spes handler object will be able to see when it is using that
  table.

  Please read the object definition in ha_spes.h before reading the rest
  of this file.
  ...
  Here you see that the spes storage engine has 9 rows called before
...
#include "storage/spes/ha_spes.h"
...
handlerton *spes_hton;

/* Interface to mysqld, to check system tables supported by SE */
static bool spes_is_supported_system_table(const char *db,
...
static int spes_init_func(void *p) {
  ...
  spes_hton = (handlerton *)p;
  spes_hton->state = SHOW_OPTION_YES;
  spes_hton->create = spes_create_handler;
  spes_hton->flags = HTON_CAN_RECREATE;
  spes_hton->is_supported_system_table = spes_is_supported_system_table;
...
static handler *spes_create_handler(handlerton *hton, TABLE_SHARE *table,
  ...
  return new (mem_root) ha_spes(hton, table);
}

ha_spes::ha_spes(handlerton *hton, TABLE_SHARE *table_arg)
...
*/
static st_handler_tablename ha_spes_system_tables[] = {
...
/**
  ...
  See ha_tina.cc for an spes of extracting all of the data as strings.
  ha_berekly.cc has an spes of how to store it intact by "packing" it
...
*/
int ha_spes::update_row(const uchar *, uchar *) {
  DBUG_TRACE;
...
int ha_spes::delete_row(const uchar *) {
  DBUG_TRACE;
  return HA_ERR_WRONG_COMMAND;
}
...
int ha_spes::index_read_map(uchar *, const uchar *, key_part_map,
...
/**
  ...
  scan. See the spes in the introduction at the top of this file to see when
  rnd_init() is called.
...
*/
void ha_spes::position(const uchar *) { DBUG_TRACE; }
...
*/
int ha_spes::rnd_pos(uchar *, uchar *) {
  int rc;
  DBUG_TRACE;
  rc = HA_ERR_WRONG_COMMAND;
  return rc;
...
/**
  ...
  ha_innodb.cc
*/
int ha_spes::extra(enum ha_extra_function) {
  DBUG_TRACE;
  return 0;
}
...
*/
int ha_spes::external_lock(THD *, int) {
  DBUG_TRACE;
  return 0;
}
...
/**
  ...
  Berkeley DB, for spes, changes all WRITE locks to TL_WRITE_ALLOW_WRITE
...
*/
THR_LOCK_DATA **ha_spes::store_lock(THD *, THR_LOCK_DATA **to,
...
*/
int ha_spes::rename_table(const char *, const char *, const dd::Table *,
                             dd::Table *) {
  DBUG_TRACE;
  return HA_ERR_WRONG_COMMAND;
}
...
*/
ha_rows ha_spes::records_in_range(uint, key_range *, key_range *) {
  DBUG_TRACE;
...
struct st_mysql_storage_engine spes_storage_engine = {
...
static SYS_VAR *spes_system_variables[] = {
...
// this is an spes of SHOW_FUNC
static int show_func_spes(MYSQL_THD, SHOW_VAR *var, char *buf) {
  var->type = SHOW_CHAR;
...
spes_vars_t spes_vars = {100, 20.01, "three hundred", true, false, 8250};

static SHOW_VAR show_status_spes[] = {
    {"var1", (char *)&spes_vars.var1, SHOW_LONG, SHOW_SCOPE_GLOBAL},
    {"var2", (char *)&spes_vars.var2, SHOW_DOUBLE, SHOW_SCOPE_GLOBAL},
    {nullptr, nullptr, SHOW_UNDEF,
     SHOW_SCOPE_UNDEF}  // null terminator required
};

static SHOW_VAR show_array_spes[] = {
    {"array", (char *)show_status_spes, SHOW_ARRAY, SHOW_SCOPE_GLOBAL},
    {"var3", (char *)&spes_vars.var3, SHOW_CHAR, SHOW_SCOPE_GLOBAL},
    {"var4", (char *)&spes_vars.var4, SHOW_BOOL, SHOW_SCOPE_GLOBAL},
    {nullptr, nullptr, SHOW_UNDEF, SHOW_SCOPE_UNDEF}};

static SHOW_VAR func_status[] = {
    {"spes_func_spes", (char *)show_func_spes, SHOW_FUNC,
     SHOW_SCOPE_GLOBAL},
    {"spes_status_var5", (char *)&spes_vars.var5, SHOW_BOOL,
     SHOW_SCOPE_GLOBAL},
    {"spes_status_var6", (char *)&spes_vars.var6, SHOW_LONG,
     SHOW_SCOPE_GLOBAL},
    {"spes_status", (char *)show_array_spes, SHOW_ARRAY,
     SHOW_SCOPE_GLOBAL},
    {nullptr, nullptr, SHOW_UNDEF, SHOW_SCOPE_UNDEF}};

mysql_declare_plugin(spes){
    ...
    PLUGIN_LICENSE_GPL,
    spes_init_func, /* Plugin Init */
    nullptr,           /* Plugin check uninstall */
    nullptr,           /* Plugin Deinit */
    0x0001 /* 0.1 */,
    func_status,              /* status variables */
    spes_system_variables, /* system variables */
